...
import "./styles.css";
const Footer = props => {
  const renderTopPanel = props => {
    return (
      <div className="container-fluid flex-space-between">
        <div className="list-with-title-wrapper">
          ...
          <ul className="list">
            <li className="list-item">
              ...
              >
                Experience Management SkavaSTUDIO
              </a>
            </li>
            <li className="list-item">
              <a
        ...
        <div className="list-with-title-wrapper">
          ...
          <ul className="list">
            ...
            <li className="list-item">
              <a className="link-styles" href="https://www.skava.com/partners/">
                Partners
              </a>
            </li>
            <li className="list-item">
              <a className="link-styles" href="https://www.skava.com/blog/">
                Blog
              </a>
            </li>
            <li className="list-item">
              <a className="link-styles" href="https://www.developer.skava.com">
                Skava Dev Portal
              </a>
            </li>
          </ul>
        ...
        <div className="list-with-title-wrapper">
          ...
          <ul className="list">
            <li className="list-item">
              <a className="link-styles" href="https://www.skava.com/about/">
                About
              </a>
            </li>
            <li className="list-item">
            ...
            <li className="list-item">
              <a className="link-styles">Email us</a>
            </li>
          </ul>
        </div>
        <address className="address-wrapper">
          <span className="address-item">Skava Corporate Headquarters</span>
          <span className="address-item">555 Mission St., Suite 1950</span>
          <span className="address-item">San Francisco, CA 94105</span>
          <span className="address-item telephone-number">877-554-2176</span>
          <a className="request-a-demo" href="https://www.skava.com/about/">
            Request a demo
          </a>
        </address>
      </div>
  ...
  const renderBottomPanel = props => {
    return (
      <div className="container-fluid flex-space-between flex-align-center height-50">
        <small>© 2019 Skava. All Rights Reserved.</small>
  ...
  return (
    <footer className="footer-wrapper">
      <section className="top-footer">{renderTopPanel()}</section>
      <section className="bottom-footer">{renderBottomPanel()}</section>
    </footer>
  );
};
